...
set KEY_NAME="HKEY_CURRENT_USER\Software\Microsoft\VisualStudio\11.0_Config"
...
if defined ValueName (
    ...
    set IDE_DIR="C:\Program Files (x86)\Microsoft Visual Studio 11.0"
    @echo VISUAL STUDIO EXPRESS DEFAULT PATH = %IDE_DIR%
    @echo IF DEFAULT PATH IS INCORRECT, PLEASE MODIFY config_visual_studio_2012.bat
    goto :no_reg
)
...
@echo VISUAL STUDIO PATH = %IDE_DIR%
